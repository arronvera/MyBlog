package code.vera.myblog.presenter.fragment;
...
import code.vera.myblog.adapter.NavigationDrawerAdapter;
...
public class MenuFragment extends RxFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // drawer labels
        titles = getActivity().getResources().getStringArray(R.array.menus);
    }
